...
сортируются в конец раздела. Этим полем добавлена электронная библиотека МГТУ
в «Общих материалах»; она же продублирована ссылкой в подвале
([Layout.jsx](../src/components/Layout.jsx)), потому что нужна с любой страницы.
