...
в каталоге библиотеки. Она не заменяет файл, а стоит рядом с ним: карточка
показывает название, кнопку «В каталоге библиотеки», а под ней файл, если он
выложен. Когда файла нет, на его месте остаётся неактивная пометка «файла нет —
читать в библиотеке»: пустое место в карточке читалось бы как недоделка,
а так видно, что книга есть, просто не у нас.
